...
type InlineResponse20015 struct {
	ContainerPruneReports []PruneReport `json:"ContainerPruneReports,omitempty"`
	ImagePruneReports []PruneReport `json:"ImagePruneReports,omitempty"`
	PodPruneReport []PodPruneReport `json:"PodPruneReport,omitempty"`
	ReclaimedSpace int32 `json:"ReclaimedSpace,omitempty"`
	VolumePruneReports []PruneReport `json:"VolumePruneReports,omitempty"`
}
