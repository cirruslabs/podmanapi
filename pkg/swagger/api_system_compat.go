...
type SystemCompatApiService service
/*
SystemCompatApiService Check auth configuration
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemCompatApiSystemAuthOpts - Optional Parameters:
     * @param "Body" (optional.Interface of AuthConfig) -  Authentication to check
@return InlineResponse200
*/

type SystemCompatApiSystemAuthOpts struct {
    Body optional.Interface
}

func (a *SystemCompatApiService) SystemAuth(ctx context.Context, localVarOptionals *SystemCompatApiSystemAuthOpts) (InlineResponse200, *http.Response, error) {
	var (
...
/*
SystemCompatApiService Show disk usage
Return information about disk usage for containers, images, and volumes
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse20014
*/
func (a *SystemCompatApiService) SystemDataUsage(ctx context.Context) (InlineResponse20014, *http.Response, error) {
	var (
...
/*
SystemCompatApiService Get events
Returns events filtered on query parameters
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemCompatApiSystemEventsOpts - Optional Parameters:
...
type SystemCompatApiSystemEventsOpts struct {
    Since optional.String
    Until optional.String
    Filters optional.String
}

func (a *SystemCompatApiService) SystemEvents(ctx context.Context, localVarOptionals *SystemCompatApiSystemEventsOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemCompatApiService Get info
Returns information on the system and libpod configuration
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

*/
func (a *SystemCompatApiService) SystemInfo(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemCompatApiService Ping service
...
@return string
*/
func (a *SystemCompatApiService) SystemPing(ctx context.Context) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemCompatApiService Component Version information
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse20016
*/
func (a *SystemCompatApiService) SystemVersion(ctx context.Context) (InlineResponse20016, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
