...
type InlineResponse20014 struct {
	Containers []SystemDfContainerReport `json:"Containers,omitempty"`
	Images []SystemDfImageReport `json:"Images,omitempty"`
	Volumes []SystemDfVolumeReport `json:"Volumes,omitempty"`
}
