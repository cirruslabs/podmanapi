 ...
 * @param optional nil or *ImagesCompatApiImageBuildOpts - Optional Parameters:
...
type ImagesCompatApiImageBuildOpts struct {
...
func (a *ImagesCompatApiService) ImageBuild(ctx context.Context, localVarOptionals *ImagesCompatApiImageBuildOpts) (InlineResponse2001, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesCompatApiImageCreateOpts - Optional Parameters:
...
type ImagesCompatApiImageCreateOpts struct {
...
func (a *ImagesCompatApiService) ImageCreate(ctx context.Context, localVarOptionals *ImagesCompatApiImageCreateOpts) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *ImagesCompatApiImageDeleteOpts - Optional Parameters:
...
type ImagesCompatApiImageDeleteOpts struct {
    Force optional.Bool
    Noprune optional.Bool
}

func (a *ImagesCompatApiService) ImageDelete(ctx context.Context, name string, localVarOptionals *ImagesCompatApiImageDeleteOpts) ([]ImageDeleteResponse, *http.Response, error) {
	var (
...
@return *os.File
*/
func (a *ImagesCompatApiService) ImageGet(ctx context.Context, name string) (*os.File, *http.Response, error) {
	var (
...
/*
ImagesCompatApiService Export several images
Get a tarball containing all images and metadata for several image repositories
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param names one or more image names or IDs comma separated
@return *os.File
*/
func (a *ImagesCompatApiService) ImageGetAll(ctx context.Context, names string) (*os.File, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	localVarQueryParams.Add("names", parameterToString(names, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
*/
func (a *ImagesCompatApiService) ImageHistory(ctx context.Context, name string) (InlineResponse2005, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ImagesCompatApiService) ImageInspect(ctx context.Context, name string) (InlineResponse2006, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesCompatApiImageListOpts - Optional Parameters:
...
type ImagesCompatApiImageListOpts struct {
    All optional.Bool
    Filters optional.String
    Digests optional.Bool
}

func (a *ImagesCompatApiService) ImageList(ctx context.Context, localVarOptionals *ImagesCompatApiImageListOpts) ([]ImageSummary, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesCompatApiImageLoadOpts - Optional Parameters:
     * @param "Body" (optional.Interface of string) -  tarball of container image
     * @param "Quiet" (optional.Bool) -  not supported

*/

type ImagesCompatApiImageLoadOpts struct {
    Body optional.Interface
    Quiet optional.Bool
}

func (a *ImagesCompatApiService) ImageLoad(ctx context.Context, localVarOptionals *ImagesCompatApiImageLoadOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesCompatApiImagePruneOpts - Optional Parameters:
...
type ImagesCompatApiImagePruneOpts struct {
    Filters optional.String
}

func (a *ImagesCompatApiService) ImagePrune(ctx context.Context, localVarOptionals *ImagesCompatApiImagePruneOpts) ([]ImageDeleteResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *ImagesCompatApiImagePushOpts - Optional Parameters:
     * @param "Tag" (optional.String) -  The tag to associate with the image on the registry.
     * @param "All" (optional.Bool) -  All indicates whether to push all images related to the image list
     * @param "Compress" (optional.Bool) -  use compression on image
     * @param "Destination" (optional.String) -  destination name for the image being pushed
     * @param "XRegistryAuth" (optional.String) -  A base64-encoded auth configuration.
@return *os.File
*/

type ImagesCompatApiImagePushOpts struct {
    Tag optional.String
    All optional.Bool
...
func (a *ImagesCompatApiService) ImagePush(ctx context.Context, name string, localVarOptionals *ImagesCompatApiImagePushOpts) (*os.File, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesCompatApiImageSearchOpts - Optional Parameters:
     ...
     * @param "ListTags" (optional.Bool) -  list the available tags in the repository
@return InlineResponse2007
*/

type ImagesCompatApiImageSearchOpts struct {
    Term optional.String
    Limit optional.Int32
    Filters optional.String
    ListTags optional.Bool
}

func (a *ImagesCompatApiService) ImageSearch(ctx context.Context, localVarOptionals *ImagesCompatApiImageSearchOpts) (InlineResponse2007, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.ListTags.IsSet() {
		localVarQueryParams.Add("listTags", parameterToString(localVarOptionals.ListTags.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name the name or ID of the container
 * @param optional nil or *ImagesCompatApiImageTagOpts - Optional Parameters:
     * @param "Repo" (optional.String) -  the repository to tag in
     * @param "Tag" (optional.String) -  the name of the new tag

*/

type ImagesCompatApiImageTagOpts struct {
    Repo optional.String
    Tag optional.String
}

func (a *ImagesCompatApiService) ImageTag(ctx context.Context, name string, localVarOptionals *ImagesCompatApiImageTagOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
