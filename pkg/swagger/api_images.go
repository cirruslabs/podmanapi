 ...
 * @param optional nil or *ImagesApiImageBuildLibpodOpts - Optional Parameters:
...
type ImagesApiImageBuildLibpodOpts struct {
...
func (a *ImagesApiService) ImageBuildLibpod(ctx context.Context, localVarOptionals *ImagesApiImageBuildLibpodOpts) (InlineResponse2008, *http.Response, error) {
	var (
...
*/
func (a *ImagesApiService) ImageChangesLibpod(ctx context.Context, name string) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesApiImageDeleteAllLibpodOpts - Optional Parameters:
...
type ImagesApiImageDeleteAllLibpodOpts struct {
    Images optional.Interface
    All optional.Bool
    Force optional.Bool
}

func (a *ImagesApiService) ImageDeleteAllLibpod(ctx context.Context, localVarOptionals *ImagesApiImageDeleteAllLibpodOpts) (LibpodImagesRemoveReport, *http.Response, error) {
	var (
 ...
 * @param optional nil or *ImagesApiImageDeleteLibpodOpts - Optional Parameters:
     * @param "Force" (optional.Bool) -  remove the image even if used by containers or has other tags
@return []ImageDeleteResponse
*/

type ImagesApiImageDeleteLibpodOpts struct {
    Force optional.Bool
}

func (a *ImagesApiService) ImageDeleteLibpod(ctx context.Context, name string, localVarOptionals *ImagesApiImageDeleteLibpodOpts) ([]ImageDeleteResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ImagesApiService) ImageExistsLibpod(ctx context.Context, name string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesApiImageExportLibpodOpts - Optional Parameters:
...
type ImagesApiImageExportLibpodOpts struct {
    Format optional.String
    References optional.Interface
    Compress optional.Bool
}

func (a *ImagesApiService) ImageExportLibpod(ctx context.Context, localVarOptionals *ImagesApiImageExportLibpodOpts) (*os.File, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name the name or ID of the container
 * @param optional nil or *ImagesApiImageGetLibpodOpts - Optional Parameters:
     * @param "Format" (optional.String) -  format for exported image
     * @param "Compress" (optional.Bool) -  use compression on image
@return *os.File
*/

type ImagesApiImageGetLibpodOpts struct {
    Format optional.String
    Compress optional.Bool
}

func (a *ImagesApiService) ImageGetLibpod(ctx context.Context, name string, localVarOptionals *ImagesApiImageGetLibpodOpts) (*os.File, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ImagesApiService) ImageHistoryLibpod(ctx context.Context, name string) (InlineResponse2005, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body tarball for imported image
 * @param optional nil or *ImagesApiImageImportLibpodOpts - Optional Parameters:
...
type ImagesApiImageImportLibpodOpts struct {
...
func (a *ImagesApiService) ImageImportLibpod(ctx context.Context, body string, localVarOptionals *ImagesApiImageImportLibpodOpts) (ImageImportReport, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ImagesApiService) ImageInspectLibpod(ctx context.Context, name string) (InlineResponse20011, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesApiImageListLibpodOpts - Optional Parameters:
...
type ImagesApiImageListLibpodOpts struct {
    All optional.Bool
    Filters optional.String
}

func (a *ImagesApiService) ImageListLibpod(ctx context.Context, localVarOptionals *ImagesApiImageListLibpodOpts) ([]ImageSummary, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body tarball of container image
@return ImageLoadReport
*/
func (a *ImagesApiService) ImageLoadLibpod(ctx context.Context, body string) (ImageLoadReport, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesApiImagePruneLibpodOpts - Optional Parameters:
...
type ImagesApiImagePruneLibpodOpts struct {
    Filters optional.String
}

func (a *ImagesApiService) ImagePruneLibpod(ctx context.Context, localVarOptionals *ImagesApiImagePruneLibpodOpts) ([]ImageDeleteResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesApiImagePullLibpodOpts - Optional Parameters:
     ...
     * @param "Arch" (optional.String) -  Pull image for the specified architecture.
     * @param "OS" (optional.String) -  Pull image for the specified operating system.
     * @param "Variant" (optional.String) -  Pull image for the specified variant.
...
type ImagesApiImagePullLibpodOpts struct {
    Reference optional.String
...
func (a *ImagesApiService) ImagePullLibpod(ctx context.Context, localVarOptionals *ImagesApiImagePullLibpodOpts) (LibpodImagesPullReport, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.Arch.IsSet() {
		localVarQueryParams.Add("Arch", parameterToString(localVarOptionals.Arch.Value(), ""))
	}
 ...
 * @param optional nil or *ImagesApiImagePushLibpodOpts - Optional Parameters:
     * @param "Destination" (optional.String) -  Allows for pushing the image to a different destination than the image refers to.
     * @param "TlsVerify" (optional.Bool) -  Require TLS verification.
     * @param "XRegistryAuth" (optional.String) -  A base64-encoded auth configuration.
@return *os.File
*/

type ImagesApiImagePushLibpodOpts struct {
    Destination optional.String
    TlsVerify optional.Bool
    XRegistryAuth optional.String
}

func (a *ImagesApiService) ImagePushLibpod(ctx context.Context, name string, localVarOptionals *ImagesApiImagePushLibpodOpts) (*os.File, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ImagesApiImageSearchLibpodOpts - Optional Parameters:
...
type ImagesApiImageSearchLibpodOpts struct {
...
func (a *ImagesApiService) ImageSearchLibpod(ctx context.Context, localVarOptionals *ImagesApiImageSearchLibpodOpts) (InlineResponse2007, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name the name or ID of the container
 * @param optional nil or *ImagesApiImageTagLibpodOpts - Optional Parameters:
     * @param "Repo" (optional.String) -  the repository to tag in
     * @param "Tag" (optional.String) -  the name of the new tag

*/

type ImagesApiImageTagLibpodOpts struct {
    Repo optional.String
    Tag optional.String
}

func (a *ImagesApiService) ImageTagLibpod(ctx context.Context, name string, localVarOptionals *ImagesApiImageTagLibpodOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name the name or ID of the container
 * @param optional nil or *ImagesApiImageTreeLibpodOpts - Optional Parameters:
     * @param "Whatrequires" (optional.Bool) -  show all child images and layers of the specified image
@return InlineResponse20012
*/

type ImagesApiImageTreeLibpodOpts struct {
    Whatrequires optional.Bool
}

func (a *ImagesApiService) ImageTreeLibpod(ctx context.Context, name string, localVarOptionals *ImagesApiImageTreeLibpodOpts) (InlineResponse20012, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name the name or ID of the container
 * @param optional nil or *ImagesApiImageUntagLibpodOpts - Optional Parameters:
     * @param "Repo" (optional.String) -  the repository to untag
     * @param "Tag" (optional.String) -  the name of the tag to untag

*/

type ImagesApiImageUntagLibpodOpts struct {
    Repo optional.String
    Tag optional.String
}

func (a *ImagesApiService) ImageUntagLibpod(ctx context.Context, name string, localVarOptionals *ImagesApiImageUntagLibpodOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
