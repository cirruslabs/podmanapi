...
*/
func (a *SystemApiService) SystemDataUsageLibpod(ctx context.Context) (InlineResponse20014, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemApiSystemEventsLibpodOpts - Optional Parameters:
...
type SystemApiSystemEventsLibpodOpts struct {
...
func (a *SystemApiService) SystemEventsLibpod(ctx context.Context, localVarOptionals *SystemApiSystemEventsLibpodOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return Info
*/
func (a *SystemApiService) SystemInfoLibpod(ctx context.Context) (Info, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SystemApiService) SystemPruneLibpod(ctx context.Context) (InlineResponse20015, *http.Response, error) {
	var (
...
*/
func (a *SystemApiService) SystemVersionLibpod(ctx context.Context) (InlineResponse20016, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
